function showToast(title, message, type = "normal", duration = 3000) {
  ...
  toastComponent.classList.remove("bg-red-50", "border-red-500", "text-red-600", "bg-green-50", "border-green-500", "text-green-600", "bg-white", "border-gray-300", "text-gray-800");
